...
{
	chk=0;
	var track = document.getElementsByName("tracker");
	
	for(var i=0;i< track.length;i++)
		{
		if(track[i].checked)
			{
			track_val = track[i].value();
			chk=1;
			}
		}
	if(chk==0)
		{
		alert('Please choose a tracker');
		}
	}
</script>     
</head> 
 ...
 <!-- Popup div ends here -->
	...
	<%
		...
		try {
			...
			t=1;
		Beans.connect();
		String query = " select filename from `database` where databasetype like '"+tracker+"'";
	...
	<div id="show">
	<form id="form1" action="tracker.jsp" method="get">
	<h2>Tracker Details</h2> <br>
	<fieldset>
	<legend align="top" > Tracker </legend> <br>
	<input type="radio" name="tracker" id="tracker" value="CR Tracker"> CR Tracker <br><br>
	<input type="radio" name="tracker" id = "tracker" value="NSN Ticket Tracker"> NSN Ticket Tracker <br><br>
	</fieldset> <br><br>
	<!-- <fieldset>
