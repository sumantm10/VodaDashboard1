 ...
 <!-- Popup div ends here -->
	...
	<%
		...
		try {
			...
			t=1;
		Beans.connect();
		String query = " select filename from `database` where databasetype like '"+dbtype+"' and node like '"+node+"'";
		// String query = "select * from files where `Sr.No` = '1'";
		//String query = " select filename from `reports` where node like 'Delhi Regional'";
		Beans.dataRet(query);
	...
	<div id="show">
	<form id="form1" action="licsheet.jsp" method="get">
	<h2>LIC Sheet Details</h2> <br>
	<!-- <fieldset>
