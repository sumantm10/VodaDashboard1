...
{
	chk=0;
	var dbtype = document.getElementsByName("databasetype");
	
	for(var i=0 ; i< dbtype.length ; i++)
		{
		if(dbtype[i].checked)
			{
			db_value = dbtype[i].value;
			chk=1;
			}
		}
	if(chk==0)
 ...
 <!-- Popup div ends here -->
	...
	<%
		...
		try {
			...
			t=1;
		Beans.connect();
		String query = "select filename from `database` where databasetype like '"+dbtype+"' ";
	...
	<div id="show">
	<form id="form1" action="otherdbs.jsp" method="get">
	<h2> Other Databases</h2> <br>
	<!-- <fieldset>
	...
	-->
	<fieldset>
	<legend> Databases </legend> <br>
	<input type="radio" name="databasetype" id="databasetype" value="DXC Sheet"> DXC Sheet <br><br>
	<input type="radio" name="databasetype" id = "databasetype" value="SCR Servers"> SCR Servers <br><br>
	<input type="radio" name="databasetype" id = "databasetype" value="Node GTs"> Node GTs <br><br>
	<input type="radio" name="databasetype" id = "databasetype" value="Spare Inventory"> Spare Inventory <br><br>
	</fieldset>
	<br><br>
