...
<link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>
 ...
 
  {
	 ...
	 */
	  chk=0;
	  var nodes = document.getElementsByName("router");
...
<body>
 ...
 <!-- Popup div ends here -->
	...
	<%
		...
		String report="Router Utilization";
		...
		try {
			...
			t=1;
		Beans.connect();
		String query = " select filename from `reports` where reporttype like '"+report+"' and node like '"+router+"' and date like '"+date+"'";
	...
	%>
            ...
            <div id="show">
	<form id="form1" action="mpreports.jsp" method="get">
	<h2>Router Utilization Details</h2> <br><br>
	<!-- <fieldset>
	...
	<legend> Router </legend> <br>
	<input type="radio" name="router" id="router" value="Peera Garhi"> Delhi Regional <br><br>
	<input type="radio" name="router" id = "router" value="Gurgaon"> Delhi National <br><br>
	</fieldset>
	<br><br>
	<h4>Choose Date : </h4>
